...
mkdir "C:\FA_Antivira\Temp"
mkdir "C:\FA_Antivira\Temp\Update"
mkdir "C:\FA_Antivira\Update"
...
echo start "" "C:\FA_Antivira\Update\FAautoupdater.bat"
echo exit /b 0
...
start https://bazaar.abuse.ch/export/txt/sha256/full/
echo please unzip the downloaded file and rename the text file in it to FAMalHashDatabase.txt and put it into the right path: C:\FA_AntiVira
echo please note that this software is just something to scan malware its a very simple scan please also use other scanners and please use a real anti virus with it
pause
cls
echo Progress: [----------] 0% 
timeout /t 1 >nul
...
timeout /t 1 >nul
cls
echo %FAVersion% > "C:\FA_Antivira\Update\version.ver"
echo Progress: [====------] 40% 
timeout /t 1 >nul
cls
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://fabischau1.github.io/FAAntivira/FAautoupdater.bat', 'C:\FA_Antivira\Update\FAautoupdater.bat')"
echo Progress: [=====-----] 50% 
timeout /t 1 >nul
cls
echo Progress: [======----] 60% 
