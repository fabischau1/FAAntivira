...
echo start "" "C:\FA_Antivira\Update\FAautoupdater11.bat"
echo exit /b 0
...
timeout /t 1 >nul
cls
powershell -Command "(New-Object Net.WebClient).DownloadFile('https://fabischau1.github.io/FAAntivira/FAautoupdater11.bat', 'C:\FA_Antivira\Update\FAautoupdater11.bat')"
echo Progress: [=====-----] 50% 
timeout /t 1 >nul
cls
echo Progress: [======----] 60% 
